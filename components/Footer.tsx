  ...
  return (
    <footer className="mt-24 border-t border-black/10 bg-white">
      <div className="container mx-auto px-4 md:px-6 py-10 text-center">
        <div className="font-serif text-xl mb-4 tracking-wide">SERENOVA</div>
        ...
        <div className="flex items-center justify-center gap-5 mb-4 text-neutral-600">
          ...
          <a aria-label="Facebook" className="footer-link" href="#" target="_blank" rel="noreferrer">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <path d="M14 8h2V5h-2c-1.657 0-3 1.343-3 3v2H9v3h2v6h3v-6h2.142L17 10h-3V8c0-.552.448-1 1-1Z" fill="currentColor"/>
            </svg>
          </a>
        </div>
