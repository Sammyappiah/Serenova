  ...
  return (
    <main className="bg-cream text-deep-forest">
      ...
      <section className="relative h-[90vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center animate-fadeUp px-4">
            ...
            <p className="text-lg md:text-2xl text-cream/95 font-light drop-shadow">
      ...
      <section className="py-20 px-6 md:px-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <h2 className="font-serif text-4xl mb-6 text-sereno-green">Welcome to Serenova</h2>
          <p className="text-lg text-neutral-700 mb-6">
            Discover our eco-luxury village where sustainability meets sophistication.
            From solar-powered residences to lush gardens, Serenova blends elegance
      ...
      <section className="py-20 px-6 md:px-20 bg-white">
        <h2 className="font-serif text-4xl text-center mb-12 text-sereno-green">Our Residences</h2>
        <div className="grid md:grid-cols-3 gap-10">
          {rooms.map((room) => (
            <div key={room.id} className="rounded-2xl shadow-lg overflow-hidden bg-cream">
              <Image
                src={room.image}
                alt={room.name}
                width={500}
      ...
      <section className="py-20 px-6 md:px-20 text-center bg-cream">
        ...
        <p className="max-w-2xl mx-auto text-lg text-neutral-700 mb-8">
          Book your stay at Serenova and experience modern eco-living in harmony with nature.
        </p>
        <Link
          href="/booking"
